...
export const kpiData: KpiItem[] = [
  ...
  {
    key: "avg-beauty",
    title: "Beauty Avg. Score",
    value: "7.21",
    suffix: "/10",
    change: "↑ 0.63 vs last period",
    changeType: "up",
    color: "#f59e0b",
  ...
  {
    key: "avg-safety",
    title: "Safety Avg. Score",
    value: "7.68",
    suffix: "/10",
    change: "↑ 0.82 vs last period",
    changeType: "up",
    color: "#8b5cf6",
  ...
  {
    key: "avg-comfort",
    title: "Comfort Avg. Score",
    value: "7.45",
    suffix: "/10",
    change: "↑ 0.71 vs last period",
    changeType: "up",
    color: "#ec4899",
